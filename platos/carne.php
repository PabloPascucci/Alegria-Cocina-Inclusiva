...
<body>
    ...
    <?php
        ...
        $connect = mysqli_connect("localhost","u320308767_alegriaci","bM|0di0?N","u320308767_alegria
        "); or die("No se conecto con la BD")
        // $connect = mysqli_connect("localhost","root","","alegria") or die("No se conecto con la BD");
                ...
                if ($result) {
                    ...
                    if ($filas > 0) {
                        ...
                        echo "<p class='p_no_platos'>No hay platos de Carne Vacuna aún</p>";
                    }
                } else {
